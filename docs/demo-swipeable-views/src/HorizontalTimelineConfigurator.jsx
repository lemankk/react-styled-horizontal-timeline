  ...
  return (
    <div className={'container'} style={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexWrap: 'wrap' }}>
        ...
        <ColorIn config='stylesLabel' label='Label' {...props} />
      </div>


      <Container label='Controls'>
        <CheckIn config='isControlBarEnabled' label='Control Bar Enabled' {...props} />
        <CheckIn config='isBackEnabled' label='Back Button Enabled' {...props} />
        <CheckIn config='isForwardEnabled' label='Forward Button Enabled' {...props} />
      </Container>
    </div>
  );
};
