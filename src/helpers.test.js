/* eslint no-undef: 0 */
import { daydiff, zip, dateDistanceExtremes, getDotType } from './helpers';
...
test('test getDotType', () => {

  expect(getDotType(0, 1)).toEqual("past");
  expect(getDotType(1, 1)).toEqual("present");
  expect(getDotType(2, 1)).toEqual("future");
})